...
const Profile = () => {
    ...
    return (
        <div className='lg:ml-60 md:ml-0 md:mt-0 ml-0 lg:mt-0 px-8 mt-16 w-full max-w-[1100px] md:-mr-96 h-screen bg-CoolGray200'>
            ...
            <div className='flex justify-between px-16'>
                ...
                <div>
                    ...
                    {/*-------- MODAL --------*/}
                    <button
                        className="p-2 border rounded-lg mr-2 bg-CoolGray100 hover:text-PrimaryLightblue900
                         hover:bg-SuccessGreen400" type="button" onClick={() => setShowModal(true)}>
                        Edit Profile
                    </button>
                    <button className="p-2 border rounded-lg bg-CoolGray100 hover:text-PrimaryLightblue900
                    hover:bg-SuccessGreen400" type="button" onClick={() => setPassModal(true)}>
                        Update Password
                    </button>
                    {showModal ? (
                        <>
                                    ...
                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-CoolGray100 outline-none focus:outline-none">
                                        ...
                                        <div className="relative p-6 flex-auto bg-SecondaryTeal600">
                                            <form className="bg-gray-200 rounded px-8 pt-6 pb-8 w-full">
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" />
                                                <label className="block text-black text-sm font-bold mb-1"> Gender</label>
                                                <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" />
                                            </form>
                                        </div>
                            ...
                            <div className="flex justify-center items-center overflow-x-hidden border rounded-lg overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-CoolGray100 outline-none focus:outline-none">
                                        ...
                                        <div className="relative p-6 flex-auto bg-SecondaryTeal600">
                                            <form className="bg-gray-200 rounded px-8 pt-6 pb-8 w-full">
                                                <label className="block text-black text-sm font-bold mb-1">Current Password</label>
                                                <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" />
                                                <label className="block text-black text-sm font-bold mb-1">New Password</label>
                                                <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" />
                                                <label className="block text-black text-sm font-bold mb-1"> Confirm Password</label>
                                                <input className="shadow appearance-none border rounded w-full py-2 px-1 text-black" />
                                            </form>
                                        </div>
                                        <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
